...
import { LayoutDashboard, Receipt, Utensils as MenuIcon, ShoppingBag, Settings, LogOut, Bike, Tag, CreditCard } from "lucide-react";
    ...
    <aside className="w-64 bg-sidebar text-sidebar-foreground h-screen sticky top-0 flex flex-col border-r border-sidebar-border">
      ...
      <div className="h-16 flex items-center px-6 border-b border-sidebar-border">
        <Link to="/" className="flex items-center gap-3 transition-transform hover:scale-[1.02] active:scale-95">
          <div className="relative w-8 h-8 rounded-lg overflow-hidden bg-white shadow-sm border border-sidebar-border flex items-center justify-center p-1">
            <Image 
              src="/logo.png" 
              alt="Chao Logo" 
              width={24} 
